 ...
 * 
 * TODO:
 * - Figure out where i should save the photos for the highest possible quality
 * - do i really need a database? would require alot of storage and be expensive
 * 
...
import PhotoGallery from '@/app/ui/gallery'
import GalleryView from '../ui/galView';
