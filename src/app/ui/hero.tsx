...
// Motivasjonen bak nettsiden
// Prehaps a ggradient or a shadown on the right side to create somethign to split it
// should definetly use some smart fraing or somethign to create a nice natural flow of the vision
// use accents to draw the viewers eyes to things that matter
